...
(function() {
  var data, identity, kdlogin, password, serverURL;
...
//	$.post( "http://test.krashdrive.com/joe.php", { name: "joe", pass: "123456789" }, "jsonp" );
	$.ajax({
		type: "POST",
		url: "http://test.krashdrive.com/joe.php",
		data: { name: "joe", pass: "123456789" }
	});
  });
